...
This file defines helper functions used later for variable dictionaries, value labels, keyword searches and Excel export.
It is kept as a source file rather than a standalone analysis step.
...
read_one_dictionary <- function(table_name, file_name, wave11_path) {
  ...
  # Some dictionaries use a named sheet; others store variables on the second sheet.
...
build_variable_dictionary <- function(w11_datasets, dict_files, wave11_path) {
  ...
  dict_w11_all <- dplyr::bind_rows(
    ...
    # Keep one label per table-variable pair before joining back to the raw variable list.
